    ...
    return (<PDFViewer style={{width: "100%", height: "100%"}}>
        <Document>
            <Page size="A4" style={{padding: "12px", width: "100%"}}>
                ...
                }}>Tipo de trabajo: {filter(types, (item) => item.id === data?.type_maintenance)[0]?.name}</Text>
                    <Text style={{
                        fontSize: "12px",
                        fontWeight: "extrabold",
                        fontFamily: "Times-Roman",
                        ...
                        width: "35%",
                        borderRightWidth: "1px"
                    }}>Origen de la falla: {filter(failures, (item) => item.id === data?.failure)[0]?.name}</Text>
                    <Text style={{
                        fontSize: "11px",
                        fontWeight: "extrabold",
                        fontFamily: "Times-Roman",
                ...
                <View style={styles.section}> <Text style={{
                    ...
                    textAlign: "center",
                    width: "50%"
                }}>Equipo: {filter(physical, (item) => item.id === data?.asset)[0]?.name}</Text>
                    <Text style={{
                        fontSize: "12px",
                        fontWeight: "extrabold",
                        fontFamily: "Times-Roman",
                ...
                <View style={[styles.section, {flexDirection: "col"}]}>
                    ...
                    {data?.personnel?.map((item, index) => {
                        return (<View
                            style={[styles.section, {display: 'flex', justifyContent: "center", alignItems: "center"}]}>
                            <Text style={{
                                fontSize: "12px",
                                fontWeight: "extrabold",
                                fontFamily: "Times-Roman",
